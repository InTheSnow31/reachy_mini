...
with ReachyMini() as reachy_mini:
    ...
    pose_1 = create_head_pose(yaw=0, degrees=True, mm=True)
    pose_2 = create_head_pose(yaw=-0, degrees=True, mm=True)
    ...
    # Sequence of poses
    reachy_mini.goto_target(head=pose_1, antennas=antennas_0, duration=2.0, method=InterpolationTechnique.EASE_IN_OUT, body_yaw=MAX_BODY_YAW)

    reachy_mini.goto_target(head=pose_2, antennas=antennas_0, duration=2.0, method=InterpolationTechnique.EASE_IN_OUT, body_yaw=-MAX_BODY_YAW)
